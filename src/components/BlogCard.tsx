...
export default function ProjectCard({
	...
	return (
		<motion.div className="card p-4 rounded-lg shadow-lg mt-2 max-w-5xl" whileHover={{ scale: 1.01, boxShadow: "0px 0px 5px #72a2dc" }} whileTap={{ scale: 0.95 }} initial={{ opacity: 0, y: 20, scale: 0.9 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.4 }}>
